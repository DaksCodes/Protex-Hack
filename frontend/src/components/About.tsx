  ...
  const tabDescs: ITabDesc[] = [
    {
      ...
      secondDesc:
        "To solve this, we built a simple and unified platform that brings together expense tracking, insights, and goal planning in one place. FinPocket helps users take control of their money, develop smarter habits, and make confident financial decisions.",
    },
    {
      firstDesc:
        "Our mission is to empower individuals with smart, easy-to-use financial tools that simplify money management. We aim to make financial planning accessible, intuitive, and effective for everyone.",
      secondDesc:
        "By leveraging data-driven insights and user-friendly design, we help users make better decisions, stay consistent with their goals, and build a strong foundation for long-term financial growth.",
    },
    {
      firstDesc:
